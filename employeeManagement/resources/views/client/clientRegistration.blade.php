...
<div class="container">
    ...
    <form class="form-signin" method="post" action="{{ URL::to('client') }}">
        {!! csrf_field() !!}
        ...
        <input type="text" id="inputContactPerson" name="inputContactPerson" class="form-control" placeholder="Contact Person" required>

        <label for="inputnic" class="sr-only">NIC</label>
        <input type="text" id="inputnic" name="inputnic" class="form-control" placeholder="NIC" required>
        <br />
        <br />
