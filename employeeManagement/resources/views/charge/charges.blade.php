    ...
    <div class="row">
        <div class="col col-lg-12 " >
            <div class="panel panel-default panel-table">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col col-xs-6 text-right">
                            ...
                            <a class="btn btn-sm btn-primary btn-create" href="{{ URL::to('charge/create') }}" role="button">Create New</a>
                        </div>
                    </div>
                </div>
                ...
                <a class="btn btn-sm" href="{{ URL::to('charge/'.$charge->id.'/edit/') }}">Edit</a>
